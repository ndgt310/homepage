...
番目の訪問者です。
    ...
    <div class="box">
     <h2>
        ...
        <p><a href="board.php">掲示板></a>　　　　　->　　メッセージを投稿できます。（8/22追記）パスワードをかけたことで家族が閲覧不可になったので、好きなことを投稿してくれてOKです♩</p>
    ...
    <div class="box" id="news">
      ...
      <p>2026/05/06 公開</p>
      <p>2026/08/22 パスワード認証機能追加</p>
      <p>2026/08/30　写真を追加</p>
    </div>
    ...
    <div class="box" id="contact">
      <h2>その他</h2>
      このページは永久に存在するものではなく、削除する可能性があります。
